...
#Despite specifying the configuration, the full long dataframe was not able to be copied to spark. Had to filter it first. 
...
#Join datasets
full.pop <- inner_join(lo.spark, pop.sum.uid, by = 'Country_Region')
